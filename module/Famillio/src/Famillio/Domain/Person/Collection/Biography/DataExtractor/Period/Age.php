...
namespace Famillio\Domain\Person\Collection\Biography\DataExtractor\Period;
...
use Famillio\Domain\Person\Collection\Biography\DataExtractor\Exception\OversatisfiedExtractorException;
 ...
 * will be thrown.
 *
 * @package Famillio\Domain\Person\Collection\Biography\DataExtractor\Period
 */
class Age implements DataExtractorInterface
{
    ...
    /**
     * @param \Famillio\Domain\Person\Biography\Fact\LifespanBoundaryFactInterface $boundaryFactInterface
     *
