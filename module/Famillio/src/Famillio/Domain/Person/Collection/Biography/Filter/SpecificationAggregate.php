...
use Famillio\Domain\Person\Collection\BiographyInterface;
...
class SpecificationAggregate implements SpecificationInterface, ContextAwareSpecificationInterface
{
    ...
    public function isFactAcceptable(FactInterface $factInterface) : bool
    {
        ...
        /** @var \Famillio\Domain\Person\Collection\Biography\Filter\SpecificationInterface $specification */
     ...
     *
     * @param \Famillio\Domain\Person\Collection\Biography\Filter\SpecificationInterface $specificationInterface
     *
     * @return void
     */
     ...
     *
     * @param \Famillio\Domain\Person\Collection\BiographyInterface $biographyInterface
     *
     * @return void
     */
