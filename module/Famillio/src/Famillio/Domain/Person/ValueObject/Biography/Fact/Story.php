...
use Famillio\Domain\Person\ValueObject\Biography\Fact\Exception\PreviousVersionNotSetException;
...
class Story extends AbstractValueObject
{
    ...
    /**
     * @var \Famillio\Domain\Person\ValueObject\Biography\Fact\Story
     */
    private $previous;

    /**
     * @var \Famillio\Domain\Person\ValueObject\Gender|NULL
     */
    private $gender;
     ...
     * @param array                                                         $data
     * @param \Famillio\Domain\Person\ValueObject\Gender|NULL               $genderTarget
     * @param \Famillio\Domain\Person\ValueObject\Biography\Fact\Story|NULL $previous
     *
