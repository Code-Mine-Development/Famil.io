...
namespace Famillio\Domain\Person\ValueObject\Name;

use AGmakonts\STL\String\Text;
use Famillio\Domain\Person\ValueObject\Name\Exception\InvalidAdditionalGivenNameException;

/**
 * Class GivenName
 *
 * @package Famillio\Domain\Person\ValueObject\Name
 */
class GivenName extends AbstractCompoundName
{
    ...
    /**
     * @param \Famillio\Domain\Person\ValueObject\Name\Name $first
    ...
    /**
     * @return \Famillio\Domain\Person\ValueObject\Name\Name
     */
    ...
    /**
     * @param \Famillio\Domain\Person\ValueObject\Name\Name $name
     *
     * @return GivenName
     */
