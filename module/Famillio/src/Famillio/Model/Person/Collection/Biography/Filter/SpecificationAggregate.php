...
class SpecificationAggregate implements SpecificationInterface, ContextAwareSpecificationInterface
{
    ...
    public function isFactAcceptable(FactInterface $factInterface) : bool
    {
        ...
        /** @var \Famillio\Model\Person\Collection\Biography\Filter\SpecificationInterface $specification */
     ...
     *
     * @param \Famillio\Model\Person\Collection\Biography\Filter\SpecificationInterface $specificationInterface
     *
     * @return void
     */
