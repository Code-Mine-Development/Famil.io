...
use Famillio\Model\Person\ValueObject\Name\Exception\InvalidAdditionalGivenNameException;
...
class GivenName extends AbstractCompoundName
{
    ...
    /**
     * @param \Famillio\Model\Person\ValueObject\Name\Name $first
    ...
    /**
     * @return \Famillio\Model\Person\ValueObject\Name\Name
     */
    ...
    /**
     * @param \Famillio\Model\Person\ValueObject\Name\Name $name
     *
     * @return GivenName
     */
